...
namespace DuiLib
{
	...
	public:
		...
		//为管家定制使用
		//this->ExcuteJS(_T("alert(1);function tt(){return 999;};"));
		//this->CallJSMethod(_T("setdata"), _T("199"));
		CString ExcuteJS(CString js);
		CString CallJSMethod(CString fun, CString arg);
	protected:
		...
		CWebBrowserUIExternal* m_browserExternal;
		// DWebBrowserEvents2
