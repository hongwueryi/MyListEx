...
public:
	...
	static bool DrawImage(HDC hDC, CPaintManagerUI* pManager, const RECT& rcItem, const RECT& rcPaint, 
		TDrawInfo& drawInfo, DWORD dwAngle = 0);
    ...
    static void DrawText(HDC hDC, CPaintManagerUI* pManager, RECT& rc, LPCTSTR pstrText, \
        DWORD dwTextColor, int iFont, UINT uStyle,bool gdiplug = false,int alpha = 255);
	...
	static HBITMAP CreateBitmapFromHBITMAP(HBITMAP hBitmap, DWORD dwAngle);
