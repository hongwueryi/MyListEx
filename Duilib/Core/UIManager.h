...
#define UISTATE_ELLIPSE	     0x00000080
...
public:
	...
	void SetAnimateImage(LPCTSTR pStrImage);
	void SetMoveParentWnd(BOOL move);
	void SetAlphaBktrans(bool alphaBktrans);
private:
...
private:
	...
	CShadowUI m_shadow;
	CDuiString m_animateImage;
	BOOL m_moveParentWnd;
	BOOL m_alphaBktrans;//alpha透明，LayeredWindow
public:
	CShadowUI* GetShadow();
