...
#define  DUI_CTR_CUSTOMBUTTON					 (_T("CustonButton"))
...
#define  DUI_CTR_SQQUENCEPICTURE				 (_T("SequencePic"))
#define	 DUI_CTR_LABELEX						 (_T("LabelEx"))
#define  DUI_CTR_PROCRESSEX						 (_T("ProgressEx"))
#define  DUI_CTR_ROTATEANIMATE					 (_T("RotateAnimateUI"))
#define  DUI_CTR_ANIMATIONOPTION				 (_T("AnimationOption"))
#define  DUI_CTR_BUTTONSWITCHEX					 (_T("ButtonSwitchEx"))
///
//////////////END控件名称宏定义//////////////////////////////////////////////////
